namespace SearchDemo.ComponentModel
{
    ...
    public class SearchCategoryAttribute : Attribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchCategoryAttribute"/> class.
        /// </summary>
        /// <param name="categories">
        /// The categories to to assign to the document type to search within.
        /// </param>
        public SearchCategoryAttribute(string[] categories)
        {
